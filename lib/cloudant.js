...
function Cloudant(settings, ds) {
  ...
  this.creds = { };
  if (settings.url) {
    this.creds.url = settings.url;
  } else {
    this.creds.account = settings.username;
    this.creds.password = settings.password;
  }

  this.creds.plugin = 'retry';
  this.creds.retryAttempts = 10;
  this.creds.retryTimeout = 250;
